                    ...
                    <div className="flex gap-10 mt-15">
                        ...
                        <div className="flex flex-col" data-aos="fade-down">
                            ...
                            <div className="flex gap-3 mt-2">
                                ...
                                <a href="https://www.facebook.com/https://www.facebook.com/MuyassarMamdoh/1XGSjjVvVn/?mibextid=wwXIfr" target='_blanck'><FaFacebook className='text-white hover:text-[#1877F2] transition duration-300' size={20} /></a>
