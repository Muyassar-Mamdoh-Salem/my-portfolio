            ...
            <div className={`container mx-auto px-[5%]`}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="flex justify-center items-center" data-aos="fade-left">
                        <img className='w-[50%] lg:w-[75%] xl:w-[60%] h-full z-10 shadow-2xl shadow-[#4A90E2] hover:shadow-[#FF6F91] rounded-3xl transition duration-500 cursor-pointer pr-4' src={myphoto} alt="Image-Error" loading='lazy' />
                    </div>
                </div>
