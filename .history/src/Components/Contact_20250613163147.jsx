                ...
                <div>
                    ...
                    <div className="flex gap-10 mt-15">
                        <div className="flex flex-col" data-aos="fade-down">
                            ...
                            <h2 className='text-blue-500 mt-2' href="mailto:omar.k.0000000@gmail.com" target="_blank" rel="noopener noreferrer">
  Gmail Omar
<h2/>
                        ...
                        <div className="flex flex-col" data-aos="fade-down">
                            ...
                            <div className="flex gap-3 mt-2">
                                <a href="https://www.linkedin.com/in/muyassar-mamdoh-308869301/" target='_blanck'><FaLinkedin className='text-white hover:text-[#0A66C2] transition duration-300' size={20}/></a>
                                <a href="https://wa.me/201156403740" target='_blanck'><FaWhatsapp className='text-white hover:text-[#25D366] transition duration-300' size={20}/></a>
                                <a href="https://www.facebook.com/MuyassarMamdoh" target='_blanck'><FaFacebook className='text-white hover:text-[#1877F2] transition duration-300' size={20} /></a>
                                <a href="https://t.me/https://t.me/MuyassarMamdoh" target='_blanck'><FaTelegramPlane className='text-white hover:text-[#0088cc] transition duration-300' size={20}/></a>
                                <a href="https://github.com/Muyassar-Mamdoh-Salem" target='_blanck'><FaGithub className='text-white' size={20}/></a>
                            </div>
                        </div>
                    </div>
                </div>
                <Formik
                    ...
                    onSubmit={(values, { resetForm }) => {
                        emailjs
                            .sendForm('service_1zpcy6e', 'template_sopvzut', form.current, {
                            publicKey: 'Q3X0FMS6dElf74m5z',
                        })
                        .then(() => {
                            Swal.fire({
