                            ...
                            <div key={project.id} className="overflow-hidden">
                                <div className="border-1 border-gray-600 p-7 md:p-5 rounded-2xl" data-aos="fade-dowen">
                                    ...
                                    <div className="flex gap-3">
                                        <a href={project.live_demo} target='_blanck'><button className="text-[#4A90E2] text-[13px] border-2 shadow-2xl shadow-[#4A90E2] border-[#4A90E2] hover:text-[#FF6F91] hover:border-[#FF6F91] hover:shadow-[#FF6F91] py-1 px-6 transition duration-500 cursor-pointer rounded-3xl mt-3">Live Demo</button></a>
