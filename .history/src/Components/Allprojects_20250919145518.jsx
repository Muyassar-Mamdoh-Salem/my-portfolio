                            ...
                            <div key={project.id} className="overflow-hidden">
                                <div className="border-1 border-gray-600 p-7 md:p-5 rounded-2xl" data-aos="fade-dowen">
                                    ...
                                    <div className="flex gap-3 ">
                                        ...
                                        <a href={project.live_demo} target='_blanck'><button className="bg-[#4A90E2] text-white text-[13px] border-2 shadow-2xl border-[#4A90E2] hover:bg-[#FF6F91] hover:text-white hover:border-[#FF6F91] py-2 px-6 transition duration-500 cursor-pointer rounded-3xl">Live Demo</button></a>
                                        <a href={project.githup} target='_blanck'><button className="bg-[#4A90E2] text-white text-[13px] border-2 shadow-2xl border-[#4A90E2] hover:bg-[#FF6F91] hover:text-white hover:border-[#FF6F91] py-2 px-6 transition duration-500 cursor-pointer rounded-3xl">Githup Code</button></a>
                                    </div>
                                </div>
                            </div>
                        ))}
