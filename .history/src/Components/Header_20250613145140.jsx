...
import { MuyassarMamdoh-FrontEnd, myphoto, MuyassarMamdoh-FrontEnd } from '../../public/assets';
            ...
            <div className={`container mx-auto px-[5%]`}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="flex items-center">
                        <div data-aos="fade-right">
                            ...
                            <div className="flex flex-wrap gap-5">
                                ...
                                <a href={MuyassarMamdoh-FrontEnd} download="CV-Omar-Kamal.pdf">
                    ...
                    {opencv && <div onClick={() => setOpencv(false)} className="fixed inset-0 flex justify-center items-center w-full z-[999] bg-[#0A0F1F] p-[10%] cursor-pointer">
                            <img onClick={(e) => e.stopPropagation()} className='w-100 h-100 md:w-120 md:h-150 cursor-auto' src={MuyassarMamdoh-FrontEnd} alt="Image-Error" loading='lazy' />
                    </div>}
