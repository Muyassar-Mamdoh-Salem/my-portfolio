                    ...
                    <div className="flex gap-10 mt-15">
                        ...
                        <div className="flex flex-col" data-aos="fade-down">
                            ...
                            <div className="flex gap-3 mt-2">
                                ...
                                <a href="https://www.linkedin.com/in/muyassar-mamdoh-308869301/" target='_blanck'><FaWhatsapp className='text-white hover:text-[#25D366] transition duration-300' size={20}/></a>
