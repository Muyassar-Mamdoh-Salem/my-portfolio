            ...
            <div className={`container mx-auto px-[5%]`}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="flex items-center">
                        <div data-aos="fade-right">
                            ...
                            <div className="flex flex-wrap gap-5">
                                ...
                                <a href={Cvv} download="Muyassar-Mamdoh-FrontEnd.pdf">
                    ...
                    <div className="flex justify-center items-center" data-aos="fade-left">
                        <img className='w-[80%] lg:w-[75%] xl:w-[60%] h-full z-10 shadow-2xl shadow-[#4A90E2] hover:shadow-[#FF6F91] rounded-3xl transition duration-500 cursor-pointer pr-2' src={myphoto} alt="Image-Error" loading='lazy' />
                    </div>
                </div>
